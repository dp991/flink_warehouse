 ...
 *
 * todo connect配合定时器需要好好理解下，有点绕
 */
public class PoliceAnalysisWithConnect {
    ...
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<String> resultDS = violationInfoDS.keyBy(ViolationInfo::getCarId).connect(policeInfoDS.keyBy(PoliceInfo::getCarId))
